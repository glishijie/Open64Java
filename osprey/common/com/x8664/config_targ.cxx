...
PREG_NUM Map_Reg_To_Preg[] = {
    0x001 /* ax       */, 0x007 /* dx       */, 0x008 /* cx       */,
    0x002 /* bx       */, 0x006 /* si       */, 0x005 /* di       */,
    0x003 /* bp       */, 0x004 /* sp       */, 0x021 /* st       */,
    0x022 /* st(1)    */, 0x023 /* st(2)    */, 0x024 /* st(3)    */,
    0x025 /* st(4)    */, 0x026 /* st(5)    */, 0x027 /* st(6)    */,
    0x028 /* st(7)    */, -1 /*          */,    -1 /* flags    */,
    -1 /* fpsr     */,    -1 /* dirflags */,    -1 /* frame    */,
    0x011 /* xmm0     */, 0x012 /* xmm1     */, 0x013 /* xmm2     */,
    0x014 /* xmm3     */, 0x015 /* xmm4     */, 0x016 /* xmm5     */,
    0x017 /* xmm6     */, 0x018 /* xmm7     */, -1 /* mm0      */,
    -1 /* mm1      */,    -1 /* mm2      */,    -1 /* mm3      */,
    -1 /* mm4      */,    -1 /* mm5      */,    -1 /* mm6      */,
    -1 /* mm7      */,    0x009 /* r8       */, 0x00a /* r9       */,
    0x00b /* r10      */, 0x00c /* r11      */, 0x00d /* r12      */,
    0x00e /* r13      */, 0x00f /* r14      */, 0x010 /* r15      */,
    0x019 /* xmm8     */, 0x01a /* xmm9     */, 0x01b /* xmm10    */,
    0x01c /* xmm11    */, 0x01d /* xmm12    */, 0x01e /* xmm13    */,
    0x01f /* xmm14    */, 0x020 /* xmm15    */, -1};
...
static void Prepare_Target(void) {
  ...
  if (ISA_Name != NULL) {
    ...
    if (strcasecmp(ISA_Name, "i386") == 0 ||
        strcasecmp(ISA_Name, "ia32") == 0) {
      Target_ABI = ABI_n32;
  ...
  /* Check x87 precision. */
  if (Target_x87_Precision != 32 && Target_x87_Precision != 64 &&
...
#if defined(FRONT_END_C) || defined(FRONT_END_CPLUSPLUS)
  Target_Int_Model =
      (Target_ABI == ABI_n64) ? TARGET_INT_LP64 : TARGET_INT_ILP32;
